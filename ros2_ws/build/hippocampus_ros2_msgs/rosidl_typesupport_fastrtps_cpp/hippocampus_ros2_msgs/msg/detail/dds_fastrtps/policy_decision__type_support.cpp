...
#include "hippocampus_ros2_msgs/msg/detail/policy_decision__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hippocampus_ros2_msgs::msg::PolicyDecision;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hippocampus_ros2_msgs::msg::PolicyDecision *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hippocampus_ros2_msgs::msg::PolicyDecision *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PolicyDecision__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const hippocampus_ros2_msgs::msg::PolicyDecision *>(
...
static size_t _PolicyDecision__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PolicyDecision(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PolicyDecision__callbacks = {
...
static rosidl_message_type_support_t _PolicyDecision__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PolicyDecision__callbacks,
...
{
  return &hippocampus_ros2_msgs::msg::typesupport_fastrtps_cpp::_PolicyDecision__handle;
}
