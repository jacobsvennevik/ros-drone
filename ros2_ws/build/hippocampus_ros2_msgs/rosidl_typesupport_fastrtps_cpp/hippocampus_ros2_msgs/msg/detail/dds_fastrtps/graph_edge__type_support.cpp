...
#include "hippocampus_ros2_msgs/msg/detail/graph_edge__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hippocampus_ros2_msgs::msg::GraphEdge & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hippocampus_ros2_msgs::msg::GraphEdge & ros_message)
{
  // Member: u
  cdr >> ros_message.u;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hippocampus_ros2_msgs::msg::GraphEdge;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hippocampus_ros2_msgs::msg::GraphEdge *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hippocampus_ros2_msgs::msg::GraphEdge *>(
    untyped_ros_message);
...
{
  return &hippocampus_ros2_msgs::msg::typesupport_fastrtps_cpp::_GraphEdge__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hippocampus_ros2_msgs, msg, GraphEdge)() {
  return &hippocampus_ros2_msgs::msg::typesupport_fastrtps_cpp::_GraphEdge__handle;
}
