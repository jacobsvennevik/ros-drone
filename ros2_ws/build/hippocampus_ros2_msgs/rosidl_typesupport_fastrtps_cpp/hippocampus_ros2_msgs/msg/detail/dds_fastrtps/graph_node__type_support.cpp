...
#include "hippocampus_ros2_msgs/msg/detail/graph_node__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hippocampus_ros2_msgs::msg::GraphNode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hippocampus_ros2_msgs::msg::GraphNode & ros_message)
{
  // Member: node_id
  cdr >> ros_message.node_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hippocampus_ros2_msgs::msg::GraphNode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hippocampus_ros2_msgs::msg::GraphNode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hippocampus_ros2_msgs::msg::GraphNode *>(
    untyped_ros_message);
...
{
  return &hippocampus_ros2_msgs::msg::typesupport_fastrtps_cpp::_GraphNode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hippocampus_ros2_msgs, msg, GraphNode)() {
  return &hippocampus_ros2_msgs::msg::typesupport_fastrtps_cpp::_GraphNode__handle;
}
