...
#include "hippocampus_ros2_msgs/msg/detail/graph_snapshot__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // last_updated, stamp
#include "hippocampus_ros2_msgs/msg/detail/graph_edge__functions.h"  // edges
#include "hippocampus_ros2_msgs/msg/detail/graph_node__functions.h"  // nodes
...
size_t get_serialized_size_hippocampus_ros2_msgs__msg__GraphNode(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_hippocampus_ros2_msgs__msg__GraphNode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hippocampus_ros2_msgs, msg, GraphNode)();


using _GraphSnapshot__ros_msg_type = hippocampus_ros2_msgs__msg__GraphSnapshot;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _GraphSnapshot__ros_msg_type * ros_message = static_cast<const _GraphSnapshot__ros_msg_type *>(untyped_ros_message);
  // Field name: epoch_id
  {
  ...
  // Field name: nodes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, hippocampus_ros2_msgs, msg, GraphNode
      )()->data);
  ...
  // Field name: edges
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, hippocampus_ros2_msgs, msg, GraphEdge
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _GraphSnapshot__ros_msg_type * ros_message = static_cast<_GraphSnapshot__ros_msg_type *>(untyped_ros_message);
  // Field name: epoch_id
  {
    cdr >> ros_message->epoch_id;
  }
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      hippocampus_ros2_msgs__msg__GraphNode__Sequence__fini(&ros_message->nodes);
    }
  ...
  // Field name: edges
  {
    ...
    if (ros_message->edges.data) {
      hippocampus_ros2_msgs__msg__GraphEdge__Sequence__fini(&ros_message->edges);
    }
...
size_t get_serialized_size_hippocampus_ros2_msgs__msg__GraphSnapshot(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GraphSnapshot__ros_msg_type * ros_message = static_cast<const _GraphSnapshot__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_hippocampus_ros2_msgs__msg__GraphNode(
  ...
  // field.name edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_hippocampus_ros2_msgs__msg__GraphEdge(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _GraphSnapshot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hippocampus_ros2_msgs__msg__GraphSnapshot(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hippocampus_ros2_msgs
size_t max_serialized_size_hippocampus_ros2_msgs__msg__GraphSnapshot(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_hippocampus_ros2_msgs__msg__GraphNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_hippocampus_ros2_msgs__msg__GraphEdge(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = hippocampus_ros2_msgs__msg__GraphSnapshot;
    is_plain =
      (
...
static size_t _GraphSnapshot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hippocampus_ros2_msgs__msg__GraphSnapshot(
...
static message_type_support_callbacks_t __callbacks_GraphSnapshot = {
...
static rosidl_message_type_support_t _GraphSnapshot__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GraphSnapshot,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hippocampus_ros2_msgs, msg, GraphSnapshot)() {
  return &_GraphSnapshot__type_support;
}
