...
static const _GraphSnapshot_type_support_symbol_names_t _GraphSnapshot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hippocampus_ros2_msgs, msg, GraphSnapshot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hippocampus_ros2_msgs, msg, GraphSnapshot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hippocampus_ros2_msgs, msg, GraphSnapshot)() {
  return &::hippocampus_ros2_msgs::msg::rosidl_typesupport_c::GraphSnapshot_message_type_support_handle;
}
