...
static const _GraphNode_type_support_symbol_names_t _GraphNode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hippocampus_ros2_msgs, msg, GraphNode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hippocampus_ros2_msgs, msg, GraphNode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hippocampus_ros2_msgs, msg, GraphNode)() {
  return &::hippocampus_ros2_msgs::msg::rosidl_typesupport_c::GraphNode_message_type_support_handle;
}
